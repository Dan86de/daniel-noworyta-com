...
export function DropdownItem({
	...
	const classes = clsx(
		...
		// Text styles
		"text-left text-base/6 text-neutral-950 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]",
		// Focus
...
>) {
	return (
		<Headless.MenuHeading
			...
			className={clsx(
				className,
				"col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 font-medium text-neutral-500 text-sm/5 sm:px-3 sm:text-xs/5 dark:text-neutral-400",
			)}
		/>
	);
}
...
>) {
	return (
		<Headless.Description
			...
			className={clsx(
				className,
				"col-span-2 col-start-2 row-start-2 text-neutral-500 text-sm/5 group-data-focus:text-white sm:text-xs/5 dark:text-neutral-400 forced-colors:group-data-focus:text-[HighlightText]",
			)}
		/>
	);
}

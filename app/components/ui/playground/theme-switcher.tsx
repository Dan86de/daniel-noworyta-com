...
export const ThemeSwitcher = ({ className }: { className?: string }) => {
	...
	return (
		<div
			className={cn(
				"flex h-8 w-22 items-center justify-center space-x-1 rounded-(--toggle-radius) border-[1.5px] px-(--toggle-padding) [--toggle-padding:--spacing(0.75)] [--toggle-radius:var(--radius-3xl)]",
				className,
			)}
		>
			{tabs.map((tab) => (

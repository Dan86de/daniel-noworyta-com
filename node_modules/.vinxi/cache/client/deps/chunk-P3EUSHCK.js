import {
  require_jsx_runtime
} from "./chunk-G5OHEQIN.js";
import {
  require_react_dom
} from "./chunk-XM7DZNFZ.js";
import {
  require_react
} from "./chunk-SW6YZCAA.js";
import {
  __commonJS,
  __toESM
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React16 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef7 = React16.useRef, useEffect5 = React16.useEffect, useMemo4 = React16.useMemo, useDebugValue = React16.useDebugValue;
...
var Match = React8.memo(function MatchImpl({
  ...
  return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    ...
    parentRouteId === rootRouteId && router.options.scrollRestoration ? (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
...
function Matches() {
  ...
  const ResolvedSuspense = router.isServer || typeof document !== "undefined" && router.clientSsr ? SafeFragment : React12.Suspense;
...
function useParentMatches(opts) {
  const contextMatchId = React12.useContext(matchContext);
  return useMatches({
    select: (matches) => {
...
function useLinkProps(options, forwardedRef) {
  const router = useRouter();
  const [isTransitioning, setIsTransitioning] = React13.useState(false);
  const hasRenderFetched = React13.useRef(false);
  ...
  const _options = React13.useMemo(() => ({ ...options, from }), [options, from]);
  const next = React13.useMemo(
    () => router.buildLocation(_options),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [router, _options, currentSearch]
  );
  const preload = React13.useMemo(() => {
  ...
  const doPreload = React13.useCallback(() => {
    router.preloadRoute(_options).catch((err) => {
      console.warn(err);
      console.warn(preloadWarning);
    });
  }, [_options, router]);
  const preloadViewportIoCallback = React13.useCallback(
    (entry) => {
...
function createLink(Comp) {
  return React13.forwardRef(function CreatedLink(props, ref) {
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-P3EUSHCK.js.map

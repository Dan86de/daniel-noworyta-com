...
export function Legend({
	...
	return (
		<Headless.Legend
			...
			className={clsx(
				className,
				"font-semibold text-base/6 text-neutral-950 data-disabled:opacity-50 sm:text-sm/6 dark:text-white",
			)}
		/>
	);
}
...
>) {
	return (
		<Headless.Description
			...
			className={clsx(
				className,
				"text-base/6 text-neutral-500 data-disabled:opacity-50 sm:text-sm/6 dark:text-neutral-400",
			)}
		/>
	);
}

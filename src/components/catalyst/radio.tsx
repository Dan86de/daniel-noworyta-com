...
const colors = {
	"dark/neutral": [
		"[--radio-checked-bg:var(--color-neutral-900)] [--radio-checked-border:var(--color-neutral-950)]/90 [--radio-checked-indicator:var(--color-white)]",
		"dark:[--radio-checked-bg:var(--color-neutral-600)]",
	],
	"dark/white": [
		"[--radio-checked-bg:var(--color-neutral-900)] [--radio-checked-border:var(--color-neutral-950)]/90 [--radio-checked-indicator:var(--color-white)]",
		"dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-neutral-950)]/15 dark:[--radio-checked-indicator:var(--color-neutral-900)]",
	],
	white:
		"[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-neutral-950)]/15 [--radio-checked-indicator:var(--color-neutral-900)]",
	dark: "[--radio-checked-bg:var(--color-neutral-900)] [--radio-checked-border:var(--color-neutral-950)]/90 [--radio-checked-indicator:var(--color-white)]",
	neutral:
		"[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-neutral-600)] [--radio-checked-border:var(--color-neutral-700)]/90",

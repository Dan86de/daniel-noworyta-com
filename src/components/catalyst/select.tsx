		...
		>
			<Headless.Select
				...
				className={clsx([
					...
					// Disabled state
					"data-disabled:border-neutral-950/20 data-disabled:opacity-100 dark:data-hover:data-disabled:border-white/15 dark:data-disabled:border-white/15 dark:data-disabled:bg-white/[2.5%]",
				])}
			/>
			{!multiple && (

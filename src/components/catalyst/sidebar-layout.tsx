...
function MobileSidebar({
	...
	return (
		<Headless.Dialog open={open} onClose={close} className="lg:hidden">
			...
			>
				<div className="flex h-full flex-col rounded-lg bg-white shadow-xs ring-1 ring-neutral-950/5 dark:bg-neutral-900 dark:ring-white/10">
	...
	return (
		<div className="relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-neutral-100 dark:bg-neutral-900 dark:lg:bg-neutral-950">
			...
			<main className="flex flex-1 flex-col pb-2 lg:min-w-0 lg:pt-2 lg:pr-2 lg:pl-64">
				<div className="grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-neutral-950/5 dark:lg:bg-neutral-900 dark:lg:ring-white/10">

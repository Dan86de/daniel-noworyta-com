...
const colors = {
	...
	neutral: [
		"[--switch-bg-ring:var(--color-neutral-700)]/90 [--switch-bg:var(--color-neutral-600)] dark:[--switch-bg-ring:transparent]",
	...
	return (
		<Headless.Switch
			...
			className={clsx(
				...
				// Focus
				"focus:outline-hidden data-focus:outline-2 data-focus:outline-primary data-focus:outline-offset-2",
				// Hover
				...
				// Disabled
				"data-disabled:data-checked:bg-neutral-200 data-disabled:data-checked:ring-black/5 data-disabled:bg-neutral-200 data-disabled:opacity-50",

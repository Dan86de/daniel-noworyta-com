...
export const Route = createFileRoute("/")({
	...
	head: () => ({
		meta: [
			{
				title: "Daniel Noworyta - Developer",
			},
			{
				name: "description",
				content:
					"Daniel Noworyta: Full-stack developer at Vaillant, obsessed with good design and user experience. Building better software and inspiring others in the tech industry.",
			},
			{
				property: "og:title",
				content: "Daniel Noworyta - Developer",
			},
			{

	...
	return (
		<AnimatePresence>
			...
			>
						...
						{Array.from(digits).map((digit, idx) => (
							...
							>
								{activeIndex === digits.size - 1 && (
									<motion.div
										layout
										className="absolute inset-0 rounded-md border border-primary dark:bg-primary/25"
										initial={{
											opacity: 0,
											scale: 1.3,
											filter: "blur(0px)",
										...
										style={{
											boxShadow: "inset 0 0 12px rgba(242, 81, 24, 0.5)",
										}}
									/>
								)}
				...
				<div
					className={cn(
						"-z-1 -translate-x-[51.2px] -bottom-3 absolute right-0 left-0 h-[140px] w-[120%] rounded-t-[80%]",
